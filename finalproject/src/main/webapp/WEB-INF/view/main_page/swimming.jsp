...
<body>
	...
	<div class="container">
		...
		<div>
			...
			88서울올림픽 당시 수영 경기가 치러진 올림픽수영장은 국제규격의 50m 레인과 철저한 수질관리를 바탕으로 한 국내 최고의
			수질 등 최상의 운동 환경을 제공하며, 수영 전문 지도강사가 표준화된 영법 지도서에 따라 체계적인 강습을 제공함으로써
			회원들이 각종 영법을 조기에 마스터할 수 있도록 지도하고 있습니다. 또한 여성 전용반과 만 65세 이상 어르신을 위한
			실버반, 어린이반 등 계층별·연령별로 다양한 강습 및 자유수영 프로그램을 운영하고 있습니다
			<br><br><br>
